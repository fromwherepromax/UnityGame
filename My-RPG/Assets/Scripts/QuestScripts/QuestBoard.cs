...
public class QuestBoard : MonoBehaviour
{
    ...
    private void Update() //每帧更新
    {
        ...
        {   
            // bool canTurnIn =questToTurnIn !=null && QuestEvents.IsQuestComplete?.Invoke(questToTurnIn) == true; //检查是否可以交付任务
            // if (canTurnIn)
            // {
            //     QuestEvents.OnQuestTurnInRequested?.Invoke(questToTurnIn); //触发任务交付事件
            // }
            // else
            {
